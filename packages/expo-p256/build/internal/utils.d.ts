 ...
 */
export declare function adaptSignWithP256KeyPairReturnType(nativeResponse: sign.NativeResponse): sign.ReturnType;
/**
 ...
 */
export declare function convertPayloadToBase64(payload: Hex.Hex | Bytes.Bytes): string;
/**
