import { Bytes, Hex, PublicKey, Secp256k1, WebAuthnP256, WebCryptoP256, } from 'ox';
...
describe('from', () => {
    test('default', () => {
        const publicKey = PublicKey.toHex(Secp256k1.getPublicKey({
            privateKey: '0x72685afe259e683fa3b7819c4745383ba36366c7571fd17456fd4cd9777aedcb',
        }), {
            includePrefix: false,
        });
        const key = Key.from({
...
describe('fromSecp256k1', () => {
    ...
    test('args: publicKey', () => {
        const key = Key.fromSecp256k1({
            publicKey: PublicKey.fromHex('0x626c7f1042b6d3971be0e4c054165e36a6d6a5ace6af1773654d3360fccf0b25b0c998938d9b73e749023eb1c77f5930b5a87660deec42261a9a22fac9a56536'),
            role: 'admin',
        });
        expect(key).toMatchInlineSnapshot(`
      {
