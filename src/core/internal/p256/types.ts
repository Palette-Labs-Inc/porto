...
export type P256KeyPair = OneOf<
  WebCryptoP256.createKeyPair.ReturnType | ExpoP256.createKeyPair.ReturnType
>
...
export interface IP256 {
  ...
  createKeyPair(
    options?: OneOf<
      WebCryptoP256.createKeyPair.Options | ExpoP256.createKeyPair.Options
    >,
  ): Promise<P256KeyPair>
   ...
   */
  sign(
    options: OneOf<WebCryptoP256.sign.Options | ExpoP256.sign.Options>,
  ): Promise<Signature.Signature<false>>
}

export declare namespace sign {
  type Options = OneOf<WebCryptoP256.sign.Options | ExpoP256.sign.Options>
}
