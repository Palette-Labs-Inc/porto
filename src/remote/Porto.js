...
export const defaultConfig = {
    ...
    messenger: typeof window !== 'undefined'
        ? Messenger.bridge({
...
export function create(parameters = {}) {
    const { chains = defaultConfig.chains, implementation = defaultConfig.implementation, messenger = defaultConfig.messenger, storage = defaultConfig.storage, transports = defaultConfig.transports, } = parameters;
